...
export default Vue.extend({
  ...
  async asyncData({ $axios }) {
    const number_of_user = await $axios
      .$get('https://eo9ic0-8080.csb.app/api/get/user')
      .then((res) => {
    ...
    const bar_params = await $axios
      .$get('https://eo9ic0-8080.csb.app/api/get/message')
      .then((res) => {
    ...
    const package_table = await $axios
      .$get('https://eo9ic0-8080.csb.app/api/get/package')
      .then((res) => {
        const package_table = {}
    ...
    const line_params = await $axios
      .$get('https://eo9ic0-8080.csb.app/api/get/bill')
      .then((res) => {
        let series = {}
        for (const key in package_table) {
          series[key] = {
